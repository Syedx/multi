            ...
            <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                <div class="single_footer_area mb-100">
                    ...
                    <ul class="footer_content">
                        ...
                        <li><span>Phone:</span>98329291913</li>
                        <li><span>FAX:</span> 002 78965 369552</li>
                        <li><span>Email:</span> info@emart.com</li>
                    </ul>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="copywrite_text">
                        <p>Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://raiprajwal.com/" target="_blank">Prajwal Rai</a></p>
                    </div>
                </div>
                <!-- Payment Method -->
                <div class="col-12 col-md-6">
