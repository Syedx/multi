            ...
            <div class="row h-100 align-items-center">
                <div class="col-6">
                    <div class="welcome-note">
                        ...
                        <span class="text">Welcome to E-mart online shopping</span>
                    </div>
                </div>
                <div class="col-6">
                        ...
                        <div class="currency-dropdown">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                                                            <a class="dropdown-item" href="javascript:;" onclick="currency_change('USD');">$ USD</a>
                                                                            <a class="dropdown-item" href="javascript:;" onclick="currency_change('NEP');">Rs. NEP</a>
                                                                            <a class="dropdown-item" href="javascript:;" onclick="currency_change('BRL');">R$ BRL</a>
                                                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                <nav class="classy-navbar" id="bigshopNav">
                                        ...
                                        <div class="single-mega cn-col-2">
                                            <div class="megamenu-slides owl-carousel">
                                                <a href="shop-grid-left-sidebar.html">
                                                    <img src="frontend/img/bg-img/mega-slide-2.html" alt="">
                                                </a>
                                                <a href="shop-list-left-sidebar.html">
                                                    <img src="frontend/img/bg-img/mega-slide-1.html" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li><a href="%c3%a7ontact-us.html">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                        ...
                        <div class="search-area">
                            ...
                            <!-- Form -->
                            <form action="https://codingwithprajwal.com/search" method="GET">
...
{{--
                        <!-- Compare -->
                        <div class="cart-area">
                            <div class="cart--btn"><a href="compare.html"><i class="icofont-exchange"></i></a> <span class="cart_quantity" id="compare_counter">0</span>
                            </div>
                        </div> --}}
                        ...
                        <div class="account-area">
                            ...
                            <ul class="user-meta-dropdown">
                                @auth
                                    ...
                                    <li><a href="{{route('user.logout')}}"><i class="icofront-logout"></i>Logout</a></li>
                                @else
