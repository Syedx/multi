                                    ...
                                    <form action="{{route('billing.address',$user->id)}}" method="post">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="" class="form-control" placeholder="eg. Hegdenagar">{{$user->address}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Country</label>
                                                <input name="country" id="" class="form-control" placeholder="eg. India" value="{{$user->country}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="">State</label>
                                                <input name="state" id="" class="form-control" placeholder="eg. Haryana" value="{{$user->state}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="">City</label>
                                                <input name="city" id="" class="form-control" placeholder="eg. Panipat" value="{{$user->city}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Postcode</label>
                                                <input name="postcode" id="" class="form-control" placeholder="eg. 132103" value="{{$user->postcode}}">
                                            </div>
                                        </div>
                                ...
                                <form action="{{route('shipping.address',$user->id)}}" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <textarea name="saddress" id="" class="form-control" placeholder="eg. Hegdenagar">{{$user->saddress}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Shipping Country</label>
                                            <input name="scountry" id="" class="form-control" placeholder="eg. India" value="{{$user->scountry}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Shipping State</label>
                                            <input name="sstate" id="" class="form-control" placeholder="eg. Haryana" value="{{$user->sstate}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Shipping City</label>
                                            <input name="scity" id="" class="form-control" placeholder="eg. Panipat" value="{{$user->scity}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Shipping Postcode</label>
                                            <input name="spostcode" id="" class="form-control" placeholder="eg. 132103" value="{{$user->spostcode}}">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
