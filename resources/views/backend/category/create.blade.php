                        ...
                        <form action="{{route('category.store')}}" method="post">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Category's Title" name="title" value="{{old('title')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summary" class="form-control" rows="8" placeholder="Category's Summary..." name="summary" required>{{old('summary')}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12 d-none" id="parent_cat_div">
